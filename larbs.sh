#!/bin/sh
# Brodie's Auto Rice Boostrapping Script (LARBS)
...
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/Esmo2000/LARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Brodie's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
